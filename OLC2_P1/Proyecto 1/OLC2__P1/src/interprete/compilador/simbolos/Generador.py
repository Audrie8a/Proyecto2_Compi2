...
class Generador:
    ...
    def get_erro_json(self):
        ...
        for error in self.error_list:
            Listas.lstError.append([len(Listas.lstError),error.descripcion,error.linea, error.columna, error.date_time])
